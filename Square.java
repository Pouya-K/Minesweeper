public class Square {
    ...
    public void calculateMines(Square[][] grid, int x, int y) {
        ...
        gameState.addCheckedSquare(grid[x][y]);
        if (numOfMines == 0) {

            if (x != 0) {
                if (y != 0 && !gameState.checkedSquaresContains(grid[x - 1][y - 1])) calculateMines(grid, x - 1, y - 1);
                if (!gameState.checkedSquaresContains(grid[x - 1][y])) calculateMines(grid, x - 1, y);
                if (y != grid[0].length - 1 && !gameState.checkedSquaresContains(grid[x - 1][y + 1]))
            ...
            if (y != 0) {
                if (!gameState.checkedSquaresContains(grid[x][y - 1])) calculateMines(grid, x, y - 1);
            }
        ...
        if (grid[x][y].isVisible) {
            if (x != 0) {
                if (y != 0 && grid[x - 1][y - 1].isMine()) {
                    ...
                    gameState.setLostSquare(grid[x - 1][y - 1]);
                    lost = true;
                }
                ...
                if (grid[x - 1][y].isMine()) {
                    ...
                    gameState.setLostSquare(grid[x - 1][y]);
                    lost = true;
                }
            ...
            if (y != 0 && grid[x][y - 1].isMine()) {
                ...
                gameState.setLostSquare(grid[x][y - 1]);
                lost = true;
            }
    ...
    public Square(int x, int y, GameState gameState) {
        this.x = x;
        this.y = y;
